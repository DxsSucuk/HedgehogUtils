    ...
    public static class Language
    {
        ...
        public static void Initialize()
        {
            ...
            LanguageAPI.Add(HedgehogUtilsPlugin.Prefix + "PURPLE_EMERALD_LORE", dataScraperOpening + FileNotFoundEmeraldLogHelper(sb, 4) + dataScraperEnding +
                "It was at this point we gave it the name \"The End\". The Chaos Emeralds powered our newest weapons in this last fight against it. Even with our finest technology fueled by the incredible power of the emeralds, we could not match its overwhelming power. As a last resort, we sealed it within cyber space.\n\nThe End is far more terrifying than I imagined. It's intelligent. It's.. clever. It can speak our language. It knows who we are on a personal level, as if it has witnessed our past.\n\nHow does a being, with no purpose other than indiscriminately destroying all, know so much? What worries me even more is why it knows all this.\n\nEven managing to subdue its destructive power by trapping it in cyber space, the End cannot be underestimated. Its ability to understand others will make it dangerously manipulative.");
            ...
            LanguageAPI.Add(HedgehogUtilsPlugin.Prefix + "RED_EMERALD_LORE", dataScraperOpening + FileNotFoundEmeraldLogHelper(sb, 5) + dataScraperEnding +
                "All that remains are our memories. Blips of love, of fear, of hope, of life, tethered to the charms we once held so close to our hearts. Even me and my ramblings of the past are all data stored in cyber space. It was made to keep the memories and teachings of our people from being forgotten. How ironic. A design as grand as cyber space was made for the purpose of us being remembered, and yet I hope it is forgotten. I hope no one finds us, lest they release the very thing that reduced us to this state.\n\nAfter everything thats happened, life moves on, with or without us. We had no place in this world to begin with.\n\nEven though we'll be long gone with time, I can imagine the emeralds will still remain. They were our greatest treasure. They will be our gift to this planet. The light of hope that can shine even in chaos.");
