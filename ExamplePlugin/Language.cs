    ...
    public static class Language
    {
        ...
        public static void Initialize()
        {
            ...
            LanguageAPI.Add(HedgehogUtilsPlugin.Prefix + "RED_EMERALD_LORE", dataScraperOpening + FileNotFoundEmeraldLogHelper(sb, 5) + dataScraperEnding +
                "It took our home world. It took our lives. All that remains of us are our memories, stored in cyber space. Even me and my ramblings of the past are all data stored in cyber space. It was made to keep the memories and teachings of our people from being forgotten. How ironic.\n\nA design as grand as cyber space was made to make sure our knowledge would be preserved and remembered, and yet I hope it is forgotten. I hope no one finds us, lest they release the very thing that reduced us to this state.\n\nAfter everything thats happened, life moves on, with or without us. We had no place in this world to begin with.\n\nEven though we'll be long gone with time, I can imagine the emeralds will still remain. They were our greatest treasure. They will be our gift to this planet. The light of hope that can shine even in chaos.");
